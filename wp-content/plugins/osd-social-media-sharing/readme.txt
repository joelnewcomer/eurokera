...
= 3.5.6 =
* Fixed pinterest pin it button to be HTTPS

= 3.5.5 =
* HTTPS Fix for Pinterest and Reddit

= 3.5.4 =
* HTTPS Fix for IIS users (fixed repo issue)

= 3.5.3 =
* Adjusted metabox display logic

= 3.5.2 =
* HTTPS Fix for IIS users
