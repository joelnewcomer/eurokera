...
if ( ! function_exists( 'foundationpress_scripts' ) ) :
	function foundationpress_scripts() {
		...
		wp_register_script( 'holmes', get_template_directory_uri() . '/assets/javascript/originals/holmes.js', array('jquery'), '1.0.0', true );
		wp_register_script( 'tweenmax', get_template_directory_uri() . '/assets/javascript/originals/TweenMax.min.js', array('jquery'), '1.0.0', true );
		wp_register_script( 'draggable', get_template_directory_uri() . '/assets/javascript/originals/Draggable.min.js', array('jquery'), '1.0.0', true );
