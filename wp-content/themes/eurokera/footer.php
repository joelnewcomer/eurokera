			...
			<footer id="footer">
				...
				<div class="row">
					<div class="large-12 medium-12 columns copyright text-center">
						...
						?>
						<p><?php _e( 'Copyright ', 'textdomain' ); ?> &copy;<?php echo date('Y'); ?> <?php bloginfo('name'); ?>.  <span class="no-break"><?php _e( 'All rights reserved.', 'textdomain' ); ?></span> <span class="show-for-small"><br /></span><a href="<?php echo get_permalink($icl_term_page_id); ?>"><?php _e('Terms of Use'); ?></a>. <a href="<?php echo get_permalink($icl_privacy_page_id); ?>"><?php _e('Privacy Policy'); ?></a>. <a href="<?php echo get_permalink($icl_cookie_page_id); ?>"><?php _e('Cookie Policy'); ?></a>.</a></p>
					</div>
