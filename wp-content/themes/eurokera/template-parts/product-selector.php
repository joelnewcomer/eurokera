			...
			<div id="products">
				...
				<?php if ( $the_query->have_posts() ) : ?>
					<?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
						...
						?>
						<div class="large-4 medium-4 small-6 columns text-center product-selector-product <?php echo $classes; ?> <?php echo $white; ?>" data-href="<?php echo get_permalink(wpml_object_id($post->ID, 'products', false, ICL_LANGUAGE_CODE)); ?>">
