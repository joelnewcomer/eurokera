	...
	<header id="masthead" class="site-header match-header" role="banner">
		<nav id="site-navigation" class="main-navigation top-bar row" role="navigation">
			<div class="top-bar-left">
				...
				<?php
				if (get_field('menu') == 'none' || is_page_template('page-templates/about.php') || is_page_template('page-templates/page-contact.php') && !is_page_template('page-templates/front.php')) {
			...
			<div class="top-bar-right">
				...
				if (is_page_template('page-templates/versatis.php')) {
					...
					specialties_menu();
				} elseif (get_field('menu') == 'none' || is_page_template('page-templates/about.php') || is_page_template('page-templates/front.php') || is_page_template('page-templates/page-contact.php')) {
					// do nothing	
				} else {
